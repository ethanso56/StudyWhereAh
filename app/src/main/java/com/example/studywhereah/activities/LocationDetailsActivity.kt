...
class LocationDetailsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Assigning textViews within the info window
        ...
        tv_locationAddress.setText("Clementi Mall")
        tv_location_detail_openOrClose.setText("Open")
        tv_location_detail_rating.setText("Rating: 4.3")
